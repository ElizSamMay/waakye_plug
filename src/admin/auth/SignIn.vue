...
const forgotMeChecked = ref(false)
...
async function logintoHomePage() {
    ...
    try {
        ...
        loadButton(false)
        fireFailureAlert(e.response?.data?.message ?? 'Something happened while logging in, Kindly try again.')
    }
}
...
function checkTapped() {
    forgotMeChecked.value = !forgotMeChecked.value;
}
        ...
        <div class="form-holder">
            ...
            <div class="form">
                ...
                <div class="email-container">
                    <AdminInputField fieldTitle="Email" valiadateString="Name must not be empty" v-model="email"
                        @input-change="handleValidation" :showError="showNameError" />
                </div>

                <div class="user-name">
                    <AdminInputField fieldTitle="Password" valiadateString="Name must not be empty" v-model="password"
                        @input-change="handleValidation" :showError="showNameError" />
                </div>
                ...
                <SolidButton buttonTitle="Login" :enableButton="buttonEnabled" @button-tapped="logintoHomePage"
                    :isLoading="isLoading" />
            </div>
